...
const renderInfoText = {
    1: (
        <div className='lg:w-1/2 gap-7 text-center font-josefin ex_fade-in-op' style={{ position: 'absolute', top: '55%', left: '25%' }}>
        ...
        <h1 className='text-7xl sm:text-5xl text-white font-nanum' style={{letterSpacing: '0.2em'}}> I am Egor </h1>
            ...
            <h2 className='text-5xl font-light text-white shadow-gray'> Web-developer/system engineer </h2>
